...
public class RestClientSignIn {
    ...
    public static SignInApiInterface getApiInterface() {
        return getRestClient().create(SignInApiInterface.class);
    }
    ...
    public static SignInApiInterface getApiLogin() {
        return getLogin().create(SignInApiInterface.class);
    }
